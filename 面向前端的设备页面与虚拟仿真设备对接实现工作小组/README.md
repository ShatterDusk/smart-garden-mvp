...
| 文档 | 文件名 | 说明 |
|------|--------|------|
| **文档清单** | [docs/文档清单.md](./docs/文档清单.md) | 📋 所有设备相关文档的清单和追踪 |
| **完整时序流程** | [docs/01-完整时序流程-从进入设备界面到设备正常传数据.md](./docs/01-完整时序流程-从进入设备界面到设备正常传数据.md) | 从进入设备界面到数据上传的完整时序 |
| **设备绑定时序图** | [docs/02-设备绑定到数据上传完整时序图.md](./docs/02-设备绑定到数据上传完整时序图.md) | 设备绑定到数据上传的时序图 |
| **虚拟设备设计** | [docs/03-虚拟设备模拟器重写设计文档.md](./docs/03-虚拟设备模拟器重写设计文档.md) | 虚拟设备模拟器的设计规格 |
| **设备绑定重构** | [docs/04-设备绑定逻辑重构方案.md](./docs/04-设备绑定逻辑重构方案.md) | 设备绑定逻辑的重构方案 |
| **设备管理流程** | [docs/05-设备管理流程.md](./docs/05-设备管理流程.md) | 业务流程：设备管理 |

> 📌 **提示**: 所有设备相关文档已统一迁移到本工作区管理，详见 [docs/文档清单.md](./docs/文档清单.md)
